...
4. walkthrough 5개는 [[manifest-agent-readable-catalog-v1-2026-05]]와 [[llms-newcomer-onboarding-v1]] 안에서 high-signal scenarios로 따로 묶었다. 다음 후보는 docs index UI의 section화다.
