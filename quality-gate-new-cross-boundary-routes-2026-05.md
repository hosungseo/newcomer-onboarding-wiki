...
## Gate 2 — 발견성
- [x] docs/index.html GitHub `.md` 링크 532개가 missing 0으로 유지되는가?
...
## 판정
신규 교차 route index는 인사복무·문서기안 및 예산대응·성과평가처럼 닫힌 route만 싣고, 기존 alias index와 중복 설명을 늘리지 않는 discovery 보조 index로 유지한다.
